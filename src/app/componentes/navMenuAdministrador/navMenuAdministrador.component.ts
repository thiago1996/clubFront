...
@Component({
  selector: 'app-navMenuAdministrador',
  templateUrl: './navMenuAdministrador.component.html',
  styleUrls: ['./navMenuAdministrador.component.css']
})
export class NavMenuAdministradorComponent {
